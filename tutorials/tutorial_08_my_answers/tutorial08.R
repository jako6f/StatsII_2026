...
workingMoms$attitude <- factor(workingMoms$attitude, levels=c("SD","D","A","SA"), labels=c("Strongly Disagree", "Disagree", "Agree", "Strongly Agree"))
...
workingMoms$year <- factor(workingMoms$year, levels=c("Year1977","Year1989"), labels=c("1977", "1989"))

# Plot prestige (y-axis) by your outcome (x-axis) by gender ~ year
ftable(workingMoms$attitude, workingMoms$gender, workingMoms$year)
prop.table(ftable(workingMoms$attitude, workingMoms$gender, workingMoms$year), margin=c(2,3))
prop.table(ftable(workingMoms$attitude, workingMoms$gender, workingMoms$year), margin=c(1,2))
prop.table(ftable(workingMoms$attitude, workingMoms$gender, workingMoms$year), margin=c(1,3))
