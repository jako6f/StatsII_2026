...
\begin{document}
	...
	\begin{frame}{Why are some dictators sanctioned and others spared?}
		...
		\begin{alertblock}{Core puzzle}
			Sanctions are not simply a reaction to repression. They are \textbf{selective political choices}.
		\end{alertblock}
	\end{frame}
...
\begin{frame}{The paper's answer}{A three-part framework}
	\begin{columns}[T,onlytextwidth]
		...
		\begin{block}{Pressure to sanction}
			\begin{itemize}
				\item Coups
	...
	\begin{exampleblock}{Main Hypothesis}
		\textbf{Weaker triggers create more room for strategic discretion.}
	\end{exampleblock}
\end{frame}
	...
	\begin{frame}{What exactly I replicated}
		\begin{columns}[T,onlytextwidth]
			...
			\begin{block}{Design}
				\begin{itemize}
					\item Authoritarian country-years, 1990--2010.
	...
	\begin{frame}{Takeaway}{Strong replication, modest extension}
		\begin{columns}[T,onlytextwidth]
			...
			\begin{block}{Replication}
				\begin{itemize}
					...
					\item Sender costs \& target vulnerability remain central.
				\end{itemize}
			\end{block}
		...
		\begin{alertblock}{Final message}
			Democratic sanctions are \textbf{selective}: they respond to authoritarian violations, but also to the strategic costs faced by sanctioning states.
		\end{alertblock}
	\end{frame}
